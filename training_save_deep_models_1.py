...
def main():
    ...
    torch.save(net, './saved_models/IEGM_net_NiN.pkl')
    torch.save(net.state_dict(), './saved_models/IEGM_net_state_dict_NiN.pkl')

    file = open('./saved_models/loss_acc_NiN.txt', 'w')
