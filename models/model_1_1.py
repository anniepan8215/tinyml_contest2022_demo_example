...
class IEGMNet_NiN(nn.Module):
    def __init__(self):
        ...
        #     nn.Conv2d(in_channels=1, out_channels=3, kernel_size=(10, 1), stride=(2,1), padding=0),
        #     nn.ReLU(True),
        #     nn.BatchNorm2d(3, affine=True, track_running_stats=True, eps=1e-5, momentum=0.1),
        # )
        #
        # self.conv2 = nn.Sequential(
        #     nn.Conv2d(in_channels=3, out_channels=5, kernel_size=(7, 1), stride=(2,1), padding=0),
        #     nn.ReLU(True),
        #     nn.BatchNorm2d(5, affine=True, track_running_stats=True, eps=1e-5, momentum=0.1),
        # )
        #
        # self.conv3 = nn.Sequential(
        #     nn.Conv2d(in_channels=5, out_channels=10, kernel_size=(7, 1), stride=(2,1), padding=0),
        #     nn.ReLU(True),
        ...
        #     nn.Dropout(0.5),
        #     nn.Linear(in_features=20*36*1, out_features=10)
        # )
    ...
    def forward(self, input):
        ...
        # conv5_output = conv5_output.view(-1, 20 * 36 * 1)
